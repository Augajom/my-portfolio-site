...
function Experience() {
  ...
  return (
    <section
      id="experience"
      className="min-h-screen flex justify-center bg-black px-4 py-8 scroll-mt-24"
    >
        ...
        <div className="flex flex-col gap-8 md:gap-16 mt-10 md:mt-20">
          {expKeys.map((key, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-gray-900 p-4 md:p-6 rounded-xl flex flex-col gap-4 md:gap-6"
              >
                {/* Slider */}
                ...
                <div className="w-full text-white flex flex-col justify-center gap-2 md:gap-4 text-center">
                  ...
                  <p
                    className="text-sm text-left sm:text-base md:text-lg text-gray-200 leading-relaxed"
                    style={{ whiteSpace: "pre-line" }}
                  >
                    {exp.description}
                  </p>
